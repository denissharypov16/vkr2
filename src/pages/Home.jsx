        ...
        <section className='advantage'>
          <Container>
            ...
            <div className="advantage__cards">
              <Card card={"card"} img={People} title={"Квалифицированные сотрудники"} body={"Все наши сотрудники имеют многолетний опыт работы в сфере. Нами было реализовано множество проектов различной тематики и самой различной сложности.   "} />
              ...
              <Card card={"card"} img={Savings} title={"Экономия"} body={""} />

              <Card card={"card"} img={Services} title={"Оперативность"} body={""} />

              <Card card={"card"} img={Drone} title={"Собственное производство "} body={""} />

              <Card card={"card"} img={OwnService} title={"Свой сервис"} body={"Л"} />
            </div>
          </Container>
        </section>
