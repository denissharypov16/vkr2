          ...
          <Container>
            <ul className="Product__charactery-list">
              <li className='Product__charactery-item'>
                <Card card={"card"} img={Delivery} title={"Бесплатная доставка"} body={"Купить товар - получить бесплатную доставку"} />
              </li>

              <li className='Product__charactery-item'>
                <Card card={"card"} img={Drone6} title={"Инструкция"} body={"Наличие инструкции в коробке товара"} />
              </li>
